...
# lengthOpt1 - length of the optimized path, when the tolerance band is exactly defined
# lengthOpt2 - length of the optimized path, when the tolerance band is linearly defined(traditional way)
...
print('length = ', length)
print('lengthOpt1 = ', lengthOpt1)
print('lengthOpt2 = ', lengthOpt2)
